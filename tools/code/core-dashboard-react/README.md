...
**Wires in:** Fetches session + chat + tools against **same host** `inneranimalmedia.com` APIs. Version string in HTML (`v=`) must match after CIDI promote. Sandbox: `inneranimal-dashboard.meauxbility.workers.dev`.
