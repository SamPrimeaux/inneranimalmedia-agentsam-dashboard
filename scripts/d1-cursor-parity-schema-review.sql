-- =============================================================================
-- D1 CURSOR-PARITY SCHEMA — REVIEW BUNDLE (paste into D1 Studio or wrangler)
-- =============================================================================
-- Purpose: One file to compare against your LIVE database. Do NOT run blindly.
--          Drop or skip any block that duplicates tables you already have.
--
